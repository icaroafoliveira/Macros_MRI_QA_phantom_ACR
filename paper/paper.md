...
# Acknowledgements
The co-authors (GBV, VHCG, PHTCO, and MSQ) contributed nearly equally to coding, development, and manuscript preparation. IAFO conceived the idea for MacroQA, contributed to coding and manuscript writing, and supervised the project implementation. GBV, VHCG, PHTCO, and MSQ are students in the Medical Physics program at the University of São Paulo and worked on this project during their internship.
